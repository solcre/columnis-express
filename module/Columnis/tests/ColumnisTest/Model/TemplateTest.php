...
class TemplateTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetMainFile() {
        ...
        $this->assertEquals(realpath($path . DIRECTORY_SEPARATOR . $mainFile), $template->getMainFile());
    ...
    public function testGetDefinitionFile() {
        ...
        $this->assertEquals(realpath($path . DIRECTORY_SEPARATOR . $definitionFile), $template->getDefinitionFile());
    }
